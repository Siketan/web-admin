    ...
    return(
        <div>
            ...
            <div className="flex space-x-2">
                ...
                <NumberInput id="wa" name="wa" label="WhatsApp" value={whatsapp}  onChange={(e) => setWhatsapp(e.target.value)}/>
            </div>
            <div className="flex space-x-2">
                <MdOutlineEmail size='30px'/>
                <EmailInput id="email" name="email" label="Email" value={email}  onChange={(e) => setEmail(e.target.value)}/>
            </div>
            <button
