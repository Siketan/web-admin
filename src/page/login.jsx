      ...
      <div className="flex justify-center items-center px-3">
        <form
          ...
          <div className="mb-4 flex">
            <label htmlFor="email" className="block text-gray-700 font-medium mb-1 px-1 py-2">
          ...
          <div className="mb-4 flex">
            <label htmlFor="password" className="block text-gray-700 font-medium mb-1 px-1 py-1">
