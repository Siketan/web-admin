                        ...
                        <div className="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div className="relative z-0 w-full mb-6 group">
                                ...
                                <div className="flex items-center pt-2">
                                    <input type="radio" value="profesiPenjual" id="profesiPenjual" name="profesiPenjual" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
