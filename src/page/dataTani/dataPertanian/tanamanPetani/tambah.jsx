              ...
              <IoImageOutline /> Menampilkan Gambar
					...
					<div className="col-span-4 grid grid-cols-2 gap-4">
						...
						<TextInput
							label="Nama Gapoktan"
							disabled
							value={petani.kelompok?.gapoktan}
						/>
						<TextInput
							label="Nama Kelompok"
							disabled
							value={petani.kelompok?.namaKelompok}
						/>
						<TextInput
							label="Nama Penyuluh"
							disabled
							value={petani.dataPenyuluh?.nama}
						/>
					</div>
				</div>
			</div>
						...
						<div className="flex flex-col gap-4 justify-between flex-1">
							<div className="bg-white rounded-lg p-4">
								...
								<Select
									...
									onChange={(value) =>
										setStatusKepemilikanLahan(value)
									}
								/>
							</div>
							<div className="bg-white rounded-lg p-4">
							...
							<div className="bg-white rounded-lg p-4">
								...
								<Tabs defaultValue="semusim">
									<Tabs.List>
										<Tabs.Tab value="semusim">
											Semusim
										</Tabs.Tab>
										<Tabs.Tab value="tahunan">
											Tahunan
										</Tabs.Tab>
									</Tabs.List>
                      ...
                      DISABLED
								...
								<div className="bg-white rounded-lg p-4 rounded-tl-none flex gap-1 flex-col ">
									...
									<NumberInput
										...
										onChange={(value) =>
											setPrakiraanProduksiPanen(value)
										}
									/>
