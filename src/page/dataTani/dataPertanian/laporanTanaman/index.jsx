          ...
          <MainCard key={index} width="460px">
            <MainCard fullwidth transparent>
              <Image
                ...
                mx="auto"
                radius="md"
                src={data?.fotoTanaman}
                alt={data?.komdisiTanaman || ''}
                withPlaceholder
              />
              <div className="pt-5 px-5 md:px-0">
                ...
                <div className="flex justify-end">
                  <Link to={`/laporan-tanam/edit/${data?.id}`}>
                    <FontAwesomeIcon
                      icon={faEdit}
                      className="cursor-pointer text-blue-500 hover:text-blue-600 pr-3"
                    />
                  </Link>
                  <FontAwesomeIcon
                    icon={faTrash}
                    onClick={() => setModalDeleteData(data?.id)}
                    className="cursor-pointer text-red-500 hover:text-red-600 mt-1"
                  />
                </div>
              </div>
            </MainCard>
