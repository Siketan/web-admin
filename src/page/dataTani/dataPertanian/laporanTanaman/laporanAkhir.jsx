        ...
        <MainCard transparent row center style={{paddingTop:"50px"}}>
            <MainCard width="80%" >
                ...
                <MainCard transparent row noPadding className="mt-5">
                    <TextInput id="realisasiHasilPanen" contoh="200 Kw" name="realisasiHasilPanen" label="Realisasi Produk Tanam " value={realisasiHasilPanen}  onChange={(e) => setRealisasiHasilPanen(e.target.value)} />
                    <TextInput id="realisasiLuasLahan" contoh="4 M²" name="realisasiLuasLahan" label="Realisasi Luas Lahan Tanam " value={realisasiLuasLahan}  onChange={(e) => setRealisasiLuasLahan(e.target.value)} />
                    
                </MainCard >
                <MainCard transparent gap="10%" row>
                    <MainCard transparent noPadding  width="40%">
                        <TextInput id="kondisiTanaman" contoh="Layu" name="kondisiTanaman" label="Kondisi Tanaman " value={komdisiTanaman}  onChange={(e) => setKomdisiTanaman(e.target.value)} />
                        <TextInput type="date" id="tanggalLaporan" name="tanggalLaporan" label="Tanggal Laporan" value={tanggalLaporan}  onChange={(e) => setTanggalLaporan(e.target.value)} />
                    </MainCard >
                ...
                <MainCard transparent row style={{justifyContent:"end"}}>
                    ...
                    <Button leftIcon={<IconX size="1rem" />} onClick={()=>history(-1)} variant='outline'>Batalkan</Button>
                </MainCard>
            </MainCard>
        </MainCard>
    )
