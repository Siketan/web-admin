		...
		<Router>
			<Routes>
				...
				<Route element={<ProtectedRoute />}>
					...
					<Route
						path="/statistik/tambah"
						element={<TambahStatistik />}
					/>
					<Route
						path="/statistik/edit/:id"
						element={<EditStatistik />}
					/>
					<Route
						path="/statistik/:id"
					...
					/>
					<Route
						path="/data-tani/tambah"
						element={<TambahDataTani />}
					/>
					<Route
						path="/data-tani/laporan-tanam"
						element={<LaporanPetani />}
					/>
					<Route
						path="/data-tani/rekap-petani"
					...
					/>
					<Route
						path="/laporan-tanam/add"
						element={<TambahLaporanTanam />}
					/>
					<Route
						path="/laporan-akhir/add"
						element={<TambahLaporanAhir />}
					/>
					<Route
					...
					<Route
						path="/event-tani/tambah"
						element={<TambahEventTani />}
					/>
					<Route
						path="/event-tani/detail"
						element={<DetailEventTani />}
					/>
					<Route
						path="/info-tani/event-tani"
						element={<EventTani />}
					/>
					<Route
						path="/event-tani/edit/:id"
						element={<EditEventTani />}
					/>
					{/* info tani */}
					<Route path="/info-tani" element={<InfoTani />} />
					<Route
						path="/info-tani/tambah"
						element={<TambahInfoTani />}
					/>
					<Route
						path="/info-tani/detail"
						element={<DetailInfoTani />}
					/>
					<Route
						path="/info-tani/edit/:id"
						element={<EditInfoTani />}
					/>
					{/* Toko Tani */}
					<Route
						path="/toko-tani/tambah-penjual"
					...
					/>
					<Route
						path="/data-penyuluh/:id"
						element={<EditPenyuluhan />}
					/>
					<Route
